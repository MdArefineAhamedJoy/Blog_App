  ...
  return (
    <div className="border border-red-500">
      ...
      <div className="px-8 pb-6">
        <h2 className="py-4 text-[22px] leading-[26.82px]">How to Attract Premium Customers with High-End Liquor Pricing</h2>
        <p className="pb-4">
          Lorem Ipsum is simply dummy text of the printing and typesetting
          industry. Lorem Ipsum has been the industry's standard dummy text ever
          since the 1500s,
        </p>
        <a  className="text-[15px] leading-[18.29px] font-semibold" href="8">See All</a>
      </div>
    </div>
  );
};
